...
public class AccessLog {
	...
	private String doorID;	 //changed from int to String
	...
	public void setHour(int hour) throws IllegalArgumentException {
		if (hour >= 0 && hour <= 23) {     //changed range of hour
			this.hour = hour;
			return;
		}
	...
	public void setMinute(int minute) throws IllegalArgumentException {
		if (minute >= 0 && minute <= 59) {
			this.minute = minute;   //changed from fixed value of 9 to variable minute
			return;
		}
